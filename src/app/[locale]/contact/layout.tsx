...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Contact OpenAutomate for questions about our open-source automation platform, implementation support, or partnership opportunities. We're here to help with your automation needs.",
  keywords: [
