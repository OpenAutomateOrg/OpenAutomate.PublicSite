...
export const metadata: Metadata = generateSEOMetadata({
  ...
  description:
    "Learn about OpenAutomate's mission to democratize automation technology through open-source solutions. Discover our story, values, and commitment to providing cost-effective automation alternatives.",
  keywords: [
    'about OpenAutomate',
